...
e.preventDefault();}).button({icons:{primary:'import'}});$buttoncontainer.append(btn);$('<span style="position:absolute;overflow:hidden;display:inline-block;"></span>').css({'width':$button.outerWidth(),'height':$button.outerHeight()}).insertBefore(this.element).append(this.element);}
