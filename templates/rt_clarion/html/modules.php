 	...
 	if (!empty ($module->content)) : ?>
        ...
        <?php endif; ?>
            <div class="rt-block">
            	<div class="module-surround">
					<?php if ($module->showtitle != 0) : ?>
					<div class="module-title <?php if (preg_match("/icon[0-9]{1,}/i", $params->get('moduleclass_sfx'))) : ?>icon-surround<?php endif; ?>">
						<?php if (preg_match("/icon[0-9]{1,}/i", $params->get('moduleclass_sfx'))) : ?>
			            <div class="module-icon"></div>
			            <?php endif; ?>
			            <?php if (preg_match("/title[1-4]{1,}/i", $params->get('moduleclass_sfx'))) : ?>
            ...
            <?php if (preg_match("/shadow[0-1]{1,}/i", $params->get('moduleclass_sfx'))) : ?>
