...
<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post" class="search_result">
	...
	<fieldset class="word">
		...
		<div class="readon"><button name="Search" onclick="this.form.submit()" class="button"><?php echo JText::_('COM_SEARCH_SEARCH');?></button></div>
