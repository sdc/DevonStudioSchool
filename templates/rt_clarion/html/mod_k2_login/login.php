	...
	<form action="<?php echo JRoute::_( 'index.php', true, $params->get('usesecure')); ?>" method="post" name="login" id="form-login" >
	  ...
	  <fieldset class="input">
	    ...
	    <p id="form-login-password">
	      ...
	      <input id="modlgn_passwd" type="password" name="<?php echo (K2_JVERSION=='16') ? 'password':'passwd'?>" class="inputbox" size="18" alt="password" />
	    </p>
	    ...
	    <div class="readon"><input type="submit" name="Submit" class="button" value="<?php echo JText::_('K2_LOGIN') ?>" /></div>
	  </fieldset>
