    ...
    public function onAfterRender()
    {
        ...
        if ($option == 'com_templates' && (($view == 'styles') || (empty($view) && empty($task))))
        {
            ...
            if ($doctype == 'html')
            {
                ...
                {
                    pq('td > input[value=' . $master . ']')->parent()->next()->append('<span style="margin:0 10px;background:#c00;color:#fff;padding:2px 4px;font-family:Georgia,serif;border-radius:2px;">Master</span>');
                }
