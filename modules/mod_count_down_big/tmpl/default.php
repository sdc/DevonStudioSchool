...
<div class="cdub_main<?php echo $moduleclass_sfx ?>">
    <div class="cdub_color">
        <?php if($ev_displaytitle AND !empty($ev_title)) : ?>
            <h2 class="cdub_color"><?php echo $ev_title ?></h2>
        <?php endif; ?>
        ...
        <?php if($poweredby == "yes") : ?>
            <br /><br /><span class="small"><a  href="http://joomla-extensions.kubik-rubik.de/" target="_blank" title="CDUB - CountDown-Up Big - Kubik-Rubik Joomla! Extensions by Viktor Vogel">CDUB - CountDown-Up Big</a></span>
        <?php endif; ?>
    </div>
</div>