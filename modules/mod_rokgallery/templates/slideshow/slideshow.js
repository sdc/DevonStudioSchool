...
}});this.RokGallery.Slideshow.Progress=new Class({Extends:Fx,options:{container:null,transition:"linear",fps:24,width:100},initialize:function(i,h){this.element=document.id(i);
...
});});this.thumbs.each(function(j,k){this.thumbSize=this.thumbsWrapper[k].sumStyles(i)+(j.offsetWidth?this.thumbsWrapper[k].offsetWidth:j.get("width").toInt());
