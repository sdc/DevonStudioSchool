...
}if(!this.textarea){throw new Error('Original textarea "'+b.textarea+'" not found in the DOM.');}this.textarea.inject(this.textarea.getParent("form")).setStyle("display","none");
