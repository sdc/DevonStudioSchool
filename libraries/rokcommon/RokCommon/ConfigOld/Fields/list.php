...
class RTConfigFieldList extends RokCommon_Config_Field
{
	/**
	 * The form field type.
	 *
	...
	protected function getOptions()
	{
		...
		foreach ($this->element->children() as $option) {
			...
			$tmp = GantryHtmlSelect::option( (string) $option['value'], rc__(trim((string) $option)), 'value', 'text', ((string) $option['disabled']=='true'));
