 ...
 * @since		1.6
 */
class RokCommon_ConfigFormHelper
{
	/**
	...
	{
		$class = 'RTCommonConfig'.ucfirst($entity).ucfirst($type);
    ...
    /**
	 * Attempt to import the RokCommon_Config_Group class file if it isn't already imported.
